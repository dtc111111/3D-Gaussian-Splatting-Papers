...
- **📝 说明**：🏆 Accepted to CVPR 2024; Code link 404
...
#### [28] Gaussian Head Avatar: Ultra High-fidelity Head Avatar via Dynamic Gaussians
...
#### [29] Feature 3DGS: Supercharging 3D Gaussian Splatting to Enable Distilled Feature Fields
...
#### [30] Gaussian-Flow: 4D Reconstruction with Dynamic 3D Gaussian Particle
...
#### [31] HiFi4G: High-Fidelity Human Performance Rendering via Compact Gaussian Splatting
...
#### [33] ASH: Animatable Gaussian Splats for Efficient and Photoreal Human Rendering
...
#### [35] COLMAP-Free 3D Gaussian Splatting
...
#### [36] DrivingGaussian: Composite Gaussian Splatting for Surrounding Dynamic Autonomous Driving Scenes
...
#### [37] Triplane Meets Gaussian Splatting: Fast and Generalizable Single-View 3D Reconstruction with Transformers
...
#### [38] 3DGS-Avatar: Animatable Avatars via Deformable 3D Gaussian Splatting
...
#### [39] GAvatar: Animatable 3D Gaussian Avatars with Implicit Mesh Learning
...
#### [41] SpecNeRF: Gaussian Directional Encoding for Specular Reflections
...
#### [42] Splatter Image: Ultra-Fast Single-View 3D Reconstruction
...
#### [44] SC-GS: Sparse-Controlled Gaussian Splatting for Editable Dynamic Scenes
...
#### [45] LangSplat: 3D Language Gaussian Splatting
...
#### [46] Spacetime Gaussian Feature Splatting for Real-Time Dynamic View Synthesis
...
#### [47] VastGaussian: Vast 3D Gaussians for Large Scene Reconstruction
...
#### [48] 3DGStream: On-the-Fly Training of 3D Gaussians for Efficient Streaming of Photo-Realistic Free-Viewpoint Videos
...
#### [49] GaussianAvatar: Efficient Animatable Human Modeling from Monocular Video Using Gaussians-on-Mesh
- **🧑‍🔬 作者**：Jing Wen, Xiaoming Zhao , Jason Ren, Alexander G. Schwing, Shenlong Wang
- **🏫 单位**：University of Illinois Urbana-Champaign ⟐ Apple ⟐ UIUC
- **🔗 链接**：
- **📝 说明**：🏆 Accepted to CVPR 2024

#### [50] SplattingAvatar: Realistic Real-Time Human Avatars with Mesh-Embedded Gaussian Splatting
...
#### [51] Splat-SLAM: Dense RGB-D SLAM via 3D Gaussian Splatting
...
#### [52] 3D Geomery-aware Deformable Gaussian Splatting for Dynamic View Synthesis
...
#### [54] FreGS: 3D Gaussian Splatting with Progressive Frequency Regularization
...
#### [55] GauHuman: Articulated Gaussian Splatting for Real-Time 3D Human Rendering
...
#### [59] CoGS: Controllable Gaussian Splatting
